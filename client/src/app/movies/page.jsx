      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        <div className={`${style.poster__container} bg-slate-800 flex flex-col md:flex-row gap-3 justify-between items-center`}>
          {movies.filter((movie) => {
            ...
            return (
              <Card key={id} sx={{ maxWidth: 300, height: 400, marginTop: 8 }} className={`${style.card__container} flex flex-cow md:flex-col`}>
                <Link href={videoLink}>
                  <div className='pt-72 md:pt-0'>
                    <CardContent>
                      <Typography variant="body2" color="text.primary">
                ...
                <CardActions className='flex flex-col' disableSpacing>
                  ...
                  <div className='flex flex-col md:flex-row pt-28 md:pt-60 gap-8 md:gap-3'>
                    ...
                    <IconButton aria-label="add to watch later" onClick={() => toggleWatchLater(movie)}>
                      {isWatchLater ? (
                        <WatchLaterIcon sx={{ color: "white", fontSize: "27px" }} />
                      ) : (
                        <WatchLaterOutlinedIcon sx={{ color: "white", fontSize: "27px" }} />
                      )}
                    </IconButton>
                    <IconButton aria-label="add to favorites" onClick={() => toggleFavorite(movie)}>
                      {isFavorite ? (
